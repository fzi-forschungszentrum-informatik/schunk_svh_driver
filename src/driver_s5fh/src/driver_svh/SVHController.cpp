...
SVHController::SVHController():
  m_current_settings(eSVH_DIMENSION,SVHCurrentSettings()),  // Vectors have to be filled with objects for correct deserialization
  m_position_settings(eSVH_DIMENSION,SVHPositionSettings()),
  m_controller_feedback(eSVH_DIMENSION,SVHControllerFeedback()),
